# blitzerdatatransformer
A small java program to transform the datasets provided by http://www.cs.jhu.edu/~mdredze/datasets/sentiment/processed_acl.tar.gz to json file format. You can use this program in accordance with the Apache License Version 2.0
...
### Apache License V 2.0
   ...
   Copyright [2016] [Leonard Hövelmann]
